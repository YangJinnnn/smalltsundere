...
def load_train_images():
    ...
    """
    return decode_idx3_ubyte('train-images.idx3-ubyte')
...
def load_train_labels():
    ...
    """
    return decode_idx1_ubyte('train-labels.idx1-ubyte')
...
def load_test_images():
    ...
    :return: n*row*col维np.array对象，n为图片数量
    """
    return decode_idx3_ubyte('t10k-images.idx3-ubyte')
...
def load_test_labels():
    ...
    :return: n*1维np.array对象，n为图片数量
    """
    return decode_idx1_ubyte('t10k-labels.idx1-ubyte')
